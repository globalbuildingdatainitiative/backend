...
@strawberry.type
class Query:
    organizations: list[GraphQLOrganization] = strawberry.field(resolver=organizations_query,
        description=getdoc(organizations_query), )


@strawberry.type
class Mutation:
    add_organizations: list[GraphQLOrganization] = strawberry.field(resolver=add_organizations_mutation,
        description=getdoc(add_organizations_mutation), )


update_organizations: list[GraphQLOrganization] = strawberry.field(resolver=edit_organizations_mutation,
    description=getdoc(edit_organizations_mutation), )

delete_organizations: list[UUID] = strawberry.field(resolver=remove_organizations_mutation,
