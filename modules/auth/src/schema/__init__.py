...
from schema.user import users_query, update_user_mutation, invite_users_mutation, accept_invitation_mutation, reject_invitation_mutation
...
class Mutation:
    ...
    invite_users: InviteUsersResponse = strawberry.field(
        resolver=invite_users_mutation,
        description=getdoc(invite_users_mutation),
        permission_classes=[IsAuthenticated]
    )
    accept_invitation: bool = strawberry.field(
        resolver=accept_invitation_mutation,
        description=getdoc(accept_invitation_mutation)
    )
    reject_invitation: bool = strawberry.field(
        resolver=reject_invitation_mutation,
        description=getdoc(reject_invitation_mutation)
    )
